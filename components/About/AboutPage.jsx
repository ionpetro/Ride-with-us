          ...
          <div className="popup-mobile-menu">
            <div className="inner-wrapper">
              <div className="inner-top">
                ...
                <p className="description">
                  Histudy is a education website template. You can customize
                  all.
                </p>
                      ...
                      <div className="rbt-feature feature-style-1">
                        ...
                        <div className="feature-content">
                          ...
                          <p className="feature-description">
                            ...
                            distracted by this on readable content of when
              ...
              <div className="row g-5 align-items-start">
                ...
                >
                  <p className="mb--40 mb_sm--20">
                    ...
                    necessitatibus fuga dolore tenetur, beatae suscipit fugit
                    est ea perspiciatis quo provident nisi dolor similique
                    architecto nihil! Ipsa aspernatur aperiam recusandae
                    pariatur odit repudiandae assumenda architecto.
                  </p>
          ...
          <div className="rbt-about-area about-style-1 bg-color-extra2 rbt-section-gap">
            <div className="container">
              <div className="row g-5 align-items-start">
                ...
                >
                  <p>
                    Graduate Programs dolor sit amet consectetur adipisicing
                    elit. Nam inventore praesentium alias incidunt! Veritatis,
                    necessitatibus fuga dolore tenetur, beatae suscipit fugit
                    est ea perspiciatis quo provident nisi dolor similique
                    architecto nihil.
                  </p>
                  ...
                  <div className="inner pl--50 pl_sm--5">
                    <div className="section-title text-start">
                      ...
                      <p className="description mt--20">
                        ...
                        inventore praesentium alias incidunt! Veritatis,
                        necessitatibus fuga dolore tenetur, beatae suscipit
                        fugit est ea perspiciatis quo provident nisi dolor
